...
- `sample3.txt`: The output of `bkmk.py cpdf sample2.txt sample3.txt create`.
- `sample4.txt`: The final `cpdf` TOC after adding some entries to `sample3.txt` by hand.
- `sample5.txt`: The output of `bkmk.py gs sample4.txt sample5.txt convert`
- `sample6.txt`: The output of `bkmk.py pdftk sample5.txt sample6.txt convert`.
...
```
$ bkmk.py -h
usage: bkmk.py [-h] {cpdf,gs,pdftk} input output {convert,create} ...
...
positional arguments:
  ...
  {convert,create}  sub-commands
    convert         use this command to change a bookmark file syntax or to renumber the pages
    create          use this command to create bookmarks from a raw TOC file
